      ...
      <div>
        ...
        <div>
          <span
            ...
            style="font-size: 14px;color: rgb(27, 156, 53);"
            ><i style="margin-right: 6px;" class="el-icon-circle-check"></i
            >正常</span
          >
          <span
            v-else
          ...
          >
            <i style="margin-right: 6px;" class="el-icon-warning-outline"></i
            >已被封禁</span
          >
        </div>
      </div>
