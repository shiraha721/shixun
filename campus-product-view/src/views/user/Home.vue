    ...
    <div class="container">
      <div class="top">
        <div class="nav">
          ...
          <div class="route">
            ...
            <span @click="handleRouteSelect('/ai-chat')">AI助手</span>
      ...
      <div class="info" v-if="loginStatus">
        <div>
          <img
            :src="userInfo.userAvatar"
            style="width: 90px;width: 90px;border-radius: 50%;"
          />
        </div>
...
export default {
  ...
  created() {
    ...
    // 仅在进入 /user 根路径时默认跳转商品页
    if (this.$route.path === '/user' || this.$route.path === '/') {
